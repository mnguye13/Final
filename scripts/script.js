...
function displayResume() {
    ...
    if (document.forms["resumeSelect"]["resumeID"].value == ""){
      alert('Please Enter ResumeID');
    }
    else{
  ...
  */
  ...
  function updateResume(){
    if (document.forms["resumeSelect"]["resumeID"].value == "" || document.forms["resumeCreate"]["firstname"].value == "" && document.forms["resumeCreate"]["lastname"].value == "" ){
      alert('Please Enter ResumeID');
    }
    else{
      var id = document.getElementById('resumeID').value;
